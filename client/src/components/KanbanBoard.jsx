...
export const DraggableTaskCard = ({ task, onEdit, onDelete }) => {
  ...
  return (
    <div
      ...
      {...attributes}
      {...listeners}
      className="glass rounded-xl p-4 mb-3 cursor-grab active:cursor-grabbing hover:bg-white/10 transition-all"
    >
...
export const KanbanColumn = ({ status, title, tasks, onEdit, onDelete, icon, color }) => {
  ...
  return (
    <div className="flex-1 min-w-[300px]">
      <div
        ref={setNodeRef}
        className={`glass rounded-2xl p-4 h-full transition-all ${
