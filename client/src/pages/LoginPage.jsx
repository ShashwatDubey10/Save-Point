      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-in-up">
          <Link to="/" className="inline-flex flex-col items-center gap-3 hover:opacity-80 transition-opacity">
            <img src="/SavePointLogoTab.png" alt="Save Point" className="h-20 w-20" />
            <img src="/SavePointText.png" alt="Save Point" className="h-8" />
          </Link>
        ...
        <div className="glass rounded-2xl p-8 glow-primary animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-dark-800/50 text-gray-500">or continue with</span>
            </div>
          </div>

          {/* Social Login Buttons */}
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white hover:bg-white/10 transition-all" disabled={loading}>
